...
stopWords = ['a', 'o', 'teu','as','os','meu','de','e','me','i']
...
def main():
    ...
    listaFrasesDesenvolvimento = extrai('Corpora/dist-desen-sem-acentos.txt', 2)
...
# Aux
#--------------------------------------------------------
def preProc(Lista, acentos=True):
    perguntas = []
    for l in Lista:
        if acentos:
            # ELIMINA ACENTOS
...
def removeStopWords(list, stopWordList=stopWords):
    perguntas = []
